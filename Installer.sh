...
#Mau Ngapain Recode 
#Izin Dlu Anjing
#Hubungi AnonymousAllIndonesia@gmail.com
#ok makasih klo udh izin
clear
# Variables
b='\033[1m'
u='\033[4m'
...
echo "Tools    : MR.KINTIL $white    "
echo "Creadby  : KintilGans $white   "
echo "Contact  : ALI ATTACKER $white "
...
echo $yellow" 41) Ko-Dork"
echo $yellow" 42) admin panel figlet"
echo $yellow" 43) Lazymux"
echo $yellow" 44) LiteScript"
echo $yellow" 45) Hash Buster"
echo $yellow" 46) Hack Wifi"
echo $yellow" 47) Hack Instagram"
echo $yellow" 48) Weeman"
echo $yellow" 49) Bot Facebook"
echo $yellow" 50) Websploit"
echo $yellow" 0) Exit "
echo $white""
...
then
clear
echo -e $red"Menginstall Admin-Panel-Finder "
sleep 1
pkg install python2
...
then
clear
echo -e $red"Menginstall Lazymux "
sleep 1
pkg install python2
...
then
clear
echo -e $red"Menginstall LITESCRIPT "
sleep 1
pkg update && pkg upgrade
pkg install git
...
then
clear
echo -e $red"Menginstall Hash-Buster "
sleep 1
pkg install python2
git clone 
...
then
clear
echo -e $red"Meginstall Wifi-Hacker "
sleep 1
...
then
clear
echo -e $red"Menginstall Instahack"
pkg install python2
pip2 install requests
...
then
clear
echo -e $red"Menginstall BOT FB "
pkg install git
pkg install python2
git clone 
https://github.com/Senitopeng/BotFbBangDjon.git
cd ~/BotFbBangDjon.git
echo -e $red"T E R I N S T A L "
exit
fi
...
then
clear
echo -e $red"Menginstall Websploit "
pkg install python2
pip2 install scapy
...
then
clear
echo " Thanks To G45 CYBER TEAM+ALI ATTACKER"
sleep 1
echo " Kintil Was Here "
sleep 1
echo " GUA GANTENG "
sleep 1
echo " TQ"
